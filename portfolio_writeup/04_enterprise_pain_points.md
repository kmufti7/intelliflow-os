...
**Test Coverage:**
3 tests verify chaos mode behavior — failure triggering, probability, and error structure.
...
**Why This Matters:**
- Regex is free; LLM calls cost money
- Regex is deterministic; LLM responses vary
- Regex is fast; LLM calls add latency
...
| Costs scale too fast | ROI concerns | Regex-first extraction, LLM fallback only |
